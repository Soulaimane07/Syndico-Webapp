var demandes = document.querySelector('#total-demandes').value
var contacts = document.querySelector('#total-contacts').value

$(function(){c3.generate({
    bindto:"#campaign-v2",
    data:{columns:[
            ["Contacts",contacts],
            ["Demandes",demandes],
    ...
    donut:{
        ...
        legend:{hide:!0},
        color:{
            pattern:["#ff4f70","#5f76e8","#ff4f70","#01caf1"]
        }});
